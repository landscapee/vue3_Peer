    ...
    function define_CesiumHeatmap() {
        var CesiumHeatmap = {
            defaults: {
                ...
                maxOpacity: 0.9, // the maximum opacity used if not given in the heatmap options object
                minOpacity: 0.5, // the minimum opacity used if not given in the heatmap options object
         ...
         */
        CesiumHeatmap.create = function(viewer, bbox, options) {
            var instance = new CHInstance(viewer, bbox, options);
            return instance;
        };
...
function CHInstance(c, bb, o) {
    ...
    this._cesium = c;
    this._options = o;
    this._id = o.id ? o.id : CesiumHeatmap._getID();
...
CHInstance.prototype.remove = function(id) {
    if (this._layer) {
